...
singularity exec /home/bt392/containers/jupyter.metztli.25h.sif Rscript /rds/project/rds-SDzz0CATGms/users/bt392/03_Stat3_RNA/07_atlas_extended_mapping.R
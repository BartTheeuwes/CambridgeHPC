...
declare -A library
refdir=/rds/project/rds-SDzz0CATGms/users/bt392/04_Rabbit_ATAC_final/genome/10x_rabbit_final/
ref=OryCun2
fastqdir=/rds/project/rds-SDzz0CATGms/users/bt392/04_Rabbit_ATAC_final/data/raw/remapping/
CELLRANGERCTRL=/rds/project/rds-SDzz0CATGms/users/bt392/04_Rabbit_ATAC_final/data/raw/remapping/cellranger_atac_count.sh

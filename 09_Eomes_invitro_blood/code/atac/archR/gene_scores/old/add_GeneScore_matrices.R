...
## START TEST ##
# args$metadata <- "/bi/group/reik/ricard/data/eomes_10x_multiome/processed/atac/archR/sample_metadata_after_archR.txt.gz"
# args$outdir <- "/bi/group/reik/ricard/data/eomes_10x_multiome/results/atac/archR/gene_scores"
# args$threads <- 1
## END TEST ##

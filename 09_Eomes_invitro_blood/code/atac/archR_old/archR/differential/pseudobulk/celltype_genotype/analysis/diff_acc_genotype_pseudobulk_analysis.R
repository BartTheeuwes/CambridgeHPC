...
pdf(file.path(io$outdir,"DA_peaks_motif_enrichment_per_celltype.pdf"), width=6.5, height=5)
print(p)
dev.off()
...
pdf(file.path(io$outdir,"DA_peaks_virtual_chip_score.pdf"), width=5, height=5)
print(p)
dev.off()
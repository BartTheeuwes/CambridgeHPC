...
chrombpnet contribs_bw  -m ../../../results/atac/chrombpnet/$1/models/chrombpnet_nobias.h5 \
    -r ../../../results/atac/chrombpnet/early_differential_peaks.bed \
    ...
    -op ../../../results/atac/chrombpnet/predictions/$1_prediction
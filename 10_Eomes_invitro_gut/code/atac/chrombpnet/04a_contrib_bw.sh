...
chrombpnet contribs_bw  -m ../../../results/atac/chrombpnet/PS_EOd/models/chrombpnet_nobias.h5 \
    -r ../../../results/atac/chrombpnet/PS_EOd/auxiliary/30K_subsample_peaks.bed \
    ...
    -op ../../../results/atac/chrombpnet/PS_EOd/predictions
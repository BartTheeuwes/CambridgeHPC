...
io <- list()
io$basedir <- "/rds/project/rds-SDzz0CATGms/users/bt392/12_Eomes_T_Mixl1/T_E75/"
...
opts$rename.samples <- c(
    'sample_11' = 'sample_11KO',
    'sample_12' = 'sample_12WT',
    'sample_13' = 'sample_13KO',
    'sample_14' = 'sample_14WT',
    'sample_15' = 'sample_15KO',
    'sample_16' = 'sample_16WT'
)

## To do:
# incorporate sample information into the bar plots -> celltype-genotype average +- svd
...
for (i in unique(to.plot$stage)) {
  ...
  pdf(sprintf("%s/celltype_proportions_%s_horizontal_barplots_per_tdTom.pdf",args$outdir,i), width=10, height=height)
  print(p)
  dev.off()
  ...
  pdf(sprintf("%s/celltype_proportions_%s_horizontal_barplots_per_tdTom_dodged.pdf",args$outdir,i), width=10, height=height)
  print(p)
  dev.off()
}
...
for (i in unique(to.plot$stage)) {
  ...
  pdf(sprintf("%s/celltype_proportions_%s_horizontal_barplots_per_tdTom_no_ExE.pdf",args$outdir,i), width=10, height=height)
  print(p)
  dev.off()
  ...
  pdf(sprintf("%s/celltype_proportions_%s_horizontal_barplots_per_tdTom_no_ExE_dodged.pdf",args$outdir,i), width=10, height=height)
  print(p)
  dev.off()
}

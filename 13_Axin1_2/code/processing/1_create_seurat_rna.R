...
# Since there is no actual tdTom in this experiment, we name the dKO and WT samples as tdTom_corr = TRUE and FALSE, respectively
tdTom = data.frame(sample = names(opts$sample2stage), tdTom = opts$sample2tomato, tdTom_corr = opts$sample2tomato)

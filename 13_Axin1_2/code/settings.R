...
io <- list()
io$basedir <- "/rds/project/rds-SDzz0CATGms/users/bt392/13_Axin1_2"
...
opts$samples <- c(
   'LibA_DKOAxin1Axin2_E6_1_IGO_14590_1',
   'LibB_WT_E6_1_IGO_14590_2'
)

opts$rename.samples <- c(
   'LibA_DKOAxin1Axin2_E6_1_IGO_14590_1' = 'dKO_rep1',
   'LibB_WT_E6_1_IGO_14590_2' = 'WT_rep1'
)

opts$sample2stage <- c(
   'LibA_DKOAxin1Axin2_E6_1_IGO_14590_1' = 'E6.5',
   'LibB_WT_E6_1_IGO_14590_2' = 'E6.5'
)


opts$sample2tomato = c(
   'LibA_DKOAxin1Axin2_E6_1_IGO_14590_1' = TRUE,
   'LibB_WT_E6_1_IGO_14590_2' = FALSE
)


opts$sample2pool <- c(
   'LibA_DKOAxin1Axin2_E6_1_IGO_14590_1' = 'Rep1',
   'LibB_WT_E6_1_IGO_14590_2' = 'Rep1'
)

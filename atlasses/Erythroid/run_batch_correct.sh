...
#SBATCH --job-name eryt_atlas
#SBATCH --output atlas_corr-log-%J.txt
...
singularity exec /home/bt392/containers/jupyter.metztli.25h.sif Rscript /rds/project/rds-SDzz0CATGms/users/bt392/atlasses/Erythroid/batch_correct.R
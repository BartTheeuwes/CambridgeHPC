...
# args$indir <- file.path(io$basedir,"results_new2/atac/archR/chromvar/pseudobulk")
# args$outdir <- file.path(io$basedir,"results_new2/atac/archR/chromvar/pseudobulk/archr_vs_chromvar_comparison")
## END TEST ##

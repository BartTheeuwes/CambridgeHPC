...
#SBATCH --job-name gpu
#SBATCH --output ChromBPNet_log.txt
...
chrombpnet pipeline \
        -ifrag ../../../results/atac/chrombpnet/endo_fragments.tsv.gz \
        -d "ATAC" \
        ...
        -p ../../../results/atac/chrombpnet/peaks.bed \
        -n ../../../results/atac/chrombpnet/output_negatives.bed \
        ...
        -o ../../../results/atac/chrombpnet/chrombpnet_model/
here::i_am("rna/differential/cells/celltype/analysis/define_marker_genes.R")
...
p$add_argument('--differential_results_folder',        type="character",     help='')
...
# args <- list()
# args$differential_results_folder <- file.path(io$basedir,"results/rna/differential/cells/celltype")
# args$differential_stats <- file.path(io$basedir,"results/rna/differential/cells/celltype/diff_stats.txt")
# args$min_fold_change <- 1.0
# args$min_score <- 0.75
# args$fdr <- 0.01
# args$outdir <- file.path(io$basedir,"results/rna/differential/cells/celltype/marker_genes"); dir.create(args$outdir, showWarnings = F)
## END TEST ##

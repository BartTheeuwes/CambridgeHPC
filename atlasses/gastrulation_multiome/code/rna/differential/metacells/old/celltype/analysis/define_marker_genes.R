...
# args <- list()
# args$differential_results_folder <- file.path(io$basedir,"results/rna/differential/metacells/celltype")
...
# args$min_score <- 0.75
# args$fdr <- 0.01
# args$outdir <- file.path(io$basedir,"results/rna/differential/metacells/celltype/marker_genes"); dir.create(args$outdir, showWarnings = F)
## END TEST ##

...
p$add_argument('--mapping_seurat',    type="character",  help='Results of the Seurat mapping')
p$add_argument('--mapping_mnn',    type="character",  help='Results of the MNN mapping')

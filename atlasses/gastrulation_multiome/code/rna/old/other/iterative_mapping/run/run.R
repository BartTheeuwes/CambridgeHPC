...
if (grepl("ricard",Sys.info()['nodename'])) {
  io$standard.mnn.script <- "/Users/ricard/gastrulation_multiome_10x/iterative_mapping/run/standard_mnn.R"
  io$iterative.mnn.script <- "/Users/ricard/gastrulation_multiome_10x/iterative_mapping/run/iterative_mnn.R"
} else if(grepl("ebi",Sys.info()['nodename'])){
  io$standard.mnn.script <- "/homes/ricard/gastrulation_multiome_10x/iterative_mapping/run/standard_mnn.R"
  io$iterative.mnn.script <- "/homes/ricard/gastrulation_multiome_10x/iterative_mapping/run/iterative_mnn.R"
  io$tmpdir <- "/hps/nobackup2/research/stegle/users/ricard/gastrulation_multiome_10x/results/iterative_mapping/tmp"
} 

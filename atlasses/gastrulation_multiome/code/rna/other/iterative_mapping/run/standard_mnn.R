...
if (grepl("ricard",Sys.info()['nodename'])) {
  ...
  source("/Users/ricard/gastrulation_multiome_10x/iterative_mapping/run/utils.R")
  io$atlas.marker_genes <- "/Users/ricard/data/gastrulation10x/results/marker_genes/E8.5/marker_genes.txt.gz"
  io$script_load_data <- "/Users/ricard/gastrulation_multiome_10x/iterative_mapping/run/load_data.R"
} else {
  source("/homes/ricard/gastrulation_multiome_10x/settings.R")
  source("/homes/ricard/gastrulation_multiome_10x/iterative_mapping/run/utils.R")
  ...
  io$script_load_data <- "/homes/ricard/gastrulation_multiome_10x/iterative_mapping/run/load_data.R"
}

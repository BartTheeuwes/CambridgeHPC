...
## START TEST ##
args = {}
args["anndata"] = io["basedir"] + "/results/rna/velocyto/metacells/anndata_metacells.h5ad"
args["metadata"] = io["basedir"] + "/results/rna/velocyto/metacells/metacells_metadata.txt.gz"
args["samples"] = "all"
args["celltypes"] = "all"
args["ncores"] = 4
args["outdir"] = io["basedir"] + "/results/rna/velocyto/metacells"
## END TEST ##
...
adata = sc.read(args["anndata"])[metadata.index.values,:]

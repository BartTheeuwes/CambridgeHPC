...
args$test_mode <- F
args$outdir <- paste0(io$basedir,"/results/rna_atac/DORCs/pseudobulk")
## END TEST
...
# sce <- load_SingleCellExperiment(io$rna.sce, normalise = TRUE, remove_non_expressed_genes = TRUE)
...
#                annotation = annotation,Links = DORC_output,region  =c('Sox17'),

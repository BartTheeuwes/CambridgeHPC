...
io$dorc.pseudobulk <- paste0(io$basedir, "/results/rna_atac/GRN/DORC/pseudobulk/DORCs_samples_distance10000_noExE.rds")
#######################################
...
# save
saveRDS(DORCs.mtx, paste0(io$outdir,"/DORCs_score_matrix_pseudobulk.rds"))
...
for (i in genes.to.plot) {
  ...
  if (!file.exists(outfile)) {
    ...
    p=ggscatter(to.plot, x="expr", y="acc", fill="celltype", size=4, shape=21,

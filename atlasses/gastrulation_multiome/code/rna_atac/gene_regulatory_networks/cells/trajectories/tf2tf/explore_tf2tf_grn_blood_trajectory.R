...
io$virtual_chip.mtx <- "/Users/argelagr/data/gastrulation_multiome_10x/results_new/rna_atac/virtual_chipseq/CISBP/motifmatchr_virtual_chip.rds"
virtual_chip.mtx <- readRDS(io$virtual_chip.mtx) %>% assay()

virtual_chip.mtx[virtual_chip.mtx<=0.30] <- 0
...
chromvar_chip.mtx <- readRDS("/Users/argelagr/data/gastrulation_multiome_10x/results_new/atac/archR/chromvar_chip/chromVAR_chip_deviations_CISBP_archr.rds")[,sample_metadata$cell] %>% assay("z")
chromvar_chip.var <- apply(chromvar_chip.mtx,1,var,na.rm=T) %>% sort
...
# corr.mtx$r["RUNX1","KLF1"]
# corr.mtx.filt$r["RUNX1","KLF1"]
# corr.mtx.filt$r["GATA1","KLF1"]

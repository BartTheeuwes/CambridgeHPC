...
# I/O
io$rna.sce <- file.path(io$basedir, 'results/rna/metacells/metacells/trajectories/nmp/SingleCellExperiment_metacells.rds')
...
io$outdir <-  file.path(io$basedir,"results/rna_atac/gene_regulatory_networks/metacells/trajectories/nmp/test"); dir.create(io$outdir, showWarnings = F)
...
rna.cells.sce <- readRDS(io$rna.sce)

# SingleCellExperiment at metacell resolution
rna_metacells.sce <- readRDS(io$rna.sce)

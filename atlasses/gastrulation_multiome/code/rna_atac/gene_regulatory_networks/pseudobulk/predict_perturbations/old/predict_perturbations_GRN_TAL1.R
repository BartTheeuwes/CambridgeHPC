...
tf2gene.mtx <- readRDS("/Users/ricard/data/gastrulation_multiome_10x/results/rna_atac/gene_regulatory_networks/pseudobulk/test/corr_matrix_stringent.rds")
...
diff_rna.dt <- fread("/Users/ricard/data/10x_gastrulation_Tal1_Chimera/results/differential/pseudobulk/DE_pseudobulk.txt.gz")
diff_rna_filt.dt <- diff_rna.dt %>% .[abs(logFC)>=1 & padj_fdr<=0.01]

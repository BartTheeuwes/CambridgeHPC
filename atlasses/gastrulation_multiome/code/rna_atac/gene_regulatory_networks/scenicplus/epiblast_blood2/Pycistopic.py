...
# Project directory
projDir = '/rds/project/rds-SDzz0CATGms/users/bt392/atlasses/gastrulation_multiome/results/rna_atac/gene_regulatory_networks/scenicplus/epiblast_blood/'
# Output directory
...
plot_imputed_features(cistopic_obj,
                    ...
                    features=[markers_dict[x].index.tolist()[0] for x in ['Epiblast', 'Endothelium', 'Erythroid3']],
                    scale=False,
                    num_columns=4,

...
# Project directory
projDir = '/rds/project/rds-SDzz0CATGms/users/bt392/atlasses/gastrulation_multiome/results/rna_atac/gene_regulatory_networks/scenicplus/mesoderm/'
# Output directory
...
# TO DO: implement filtering for cells based on celltype and WT (instead of T KO)

atac_mtx = scipy.sparse.csr_matrix(atac_mtx_adata.X)
atac_mtx = pd.DataFrame.sparse.from_spmatrix(atac_mtx)

cells = atac_mtx_adata.obs.index
regions = atac_mtx_adata.var.index

atac_mtx.index = cells
atac_mtx.columns =regions
atac_mtx = atac_mtx.transpose()
# In[8]:
...
#cistopic_obj = create_cistopic_object(fragment_matrix=atac_mtx) #, path_to_blacklist=path_to_blacklist)
...
#models=run_cgs_models_mallet("/rds/project/rds-SDzz0CATGms/users/bt392/software/github/Mallet/bin/mallet", 
#                               cistopic_obj,
#                               n_topics=[2,4,10,15,25,35,45,50],
#                              n_cpu=30,
#                              n_iter=50,
#                              random_state=555,
#                              alpha=50,
...
#                               eta=0.1,
#                               eta_by_topic=False,
#                               save_path='/home/bt392/ry/c/intermediate_models/',
#                               top_topics_coh=5,
#                               tmp_path=tmpDir)
...
#            open(os.path.join(outDir, 'cisTopicObject.pkl'), 'wb'))
...
#                 reduction_name='UMAP',
#                 variables=['celltype.mapped', 'stage', 'pycisTopic_leiden_10_0.6'], # Labels from RNA and new clusters
...
#                     variables = ['celltype.mapped', 'stage'],
#                     scale = False,
#                     legend_loc_x = 1.05,
#                     legend_loc_y = -1.2,
#                     legend_dist_y = -1,
...
#topic_annot = topic_annotation(cistopic_obj, annot_var='celltype.mapped', binarized_cell_topic=binarized_cell_topic, general_topic_thr = 0.2)
...
#topic_qc_metrics = pd.concat([topic_annot[['celltype.mapped', 'Ratio_cells_in_topic', 'Ratio_group_in_population']], topic_qc_metrics], axis=1)

...
## START TEST ##
args$metadata <- file.path(io$basedir,"results/rna_atac/mofa/all_cells/sample_metadata.txt.gz")
args$mofa_model <- file.path(io$basedir,"results/rna_atac/mofa/all_cells/mofa.hdf5")
args$outdir <- file.path(io$basedir, "results/rna_atac/mofa/all_cells/pdf")

# args$metadata <- file.path(io$basedir,"results/rna_atac/mofa/all_cells/sample_metadata.txt.gz")
# args$mofa_model <- file.path(io$basedir,"results/rna_atac/mofa/all_cells/mofa_allcells_pca_lsi.rds")
# args$outdir <- file.path(io$basedir, "results/rna_atac/mofa/all_cells/pdf")
## END TEST ##
...
samples <- MOFAobject@samples_metadata$sample.1

here::i_am("rna_atac/rna_vs_acc/trajectories/run_TFexpr_vs_peakAcc_trajectories.R")
...
args$denoise <- TRUE
args$knn <- 50
args$pca_rna <- file.path(io$basedir,"results_new/rna/dimensionality_reduction/sce/pca_features1500_pcs50.txt.gz")
...
args$outdir <- file.path(io$basedir,sprintf("results_new/rna_atac/rna_vs_acc/trajectories/%s",args$trajectory_name))
args$test_mode <- TRUE
## END TEST

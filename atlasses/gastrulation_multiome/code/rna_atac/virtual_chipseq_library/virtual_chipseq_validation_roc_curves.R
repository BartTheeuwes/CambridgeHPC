...
io$outdir <- file.path(io$basedir,"results_new/rna_atac/virtual_chipseq/CISBP/stats"); dir.create(io$outdir, showWarnings = F)
...
pdf(file.path(io$outdir,"virtual_chip_roc_cuves.pdf"), width=6, height=5)
print(p)
dev.off()

...
# singularity exec /home/bt392/containers/jupyter.metztli.25h.sif /usr/sbin/jupyter notebook --no-browser --port=$ipnport --ip=$ipnip

singularity exec /rds/project/rds-SDzz0CATGms/containers/jupyter.metztli.25i.sif /usr/sbin/jupyter notebook --no-browser --port=$ipnport --ip=$ipnip